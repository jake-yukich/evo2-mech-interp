...
![Phylo tree coverage and distance distribution](images/phylo_tree_overlay_analysis.png)
...
![3D UMAP coloured by class](images/umap_3d_class.png)
...
![Cosine distance vs phylogenetic distance](images/distance_cosine_vs_phylogenetic.png)
...
![Geodesic distance vs phylogenetic distance](images/distance_geodesic_vs_phylogenetic.png)
...
![Geodesic distance, intermediate run](images/geovphylo1.png)
...
![Angular distance in flat subspace vs phylogenetic distance](images/distance_angular_vs_phylogenetic.png)
...
![3D UMAP of flat subspace coloured by class](images/flat_subspace_umap_3d_class.png)
...
![3D UMAP, 64 species, coloured by class](images/10_samples_w_accession_class.png)
...
```bash
aws s3 cp s3://evo-2-mech-interp/images/ \
  ./images/ \
  --recursive \
