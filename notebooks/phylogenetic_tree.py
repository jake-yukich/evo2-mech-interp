accession_ids = ['GB_GCA_013297995.1',
 'GB_GCA_903908015.1',
 'RS_GCF_004342685.1',
 'GB_GCA_902763505.1',
 'GB_GCA_017616785.1',
...
def mp_phylogenetic_distance_matrix(
    accession_ids: list[str], tree_path: str, n_processes: int = 12, distance_func: Callable = None
) -> torch.Tensor:
...
distance_matrix_old = _compute_distance_chunk((list(range(len(accession_ids))), accession_ids, tree_path))
end_time = perf_counter()

print(f"Time taken for old: {end_time - start_time:.2f} seconds")

start_time = perf_counter()
distance_matrix_new = _compute_distance_chunk_cached((list(range(len(accession_ids))), accession_ids, tree_path))
end_time = perf_counter()
